...
from .views import ArticleListCreate, ArticleDetail, CommentListCreate, CommentDetail, CategoryListCreate, CategoryDetail, MainArticleListView, FeatureArticleListView
